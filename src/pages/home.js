    ...
    return (
        <div className="home">
            <div className="entry">
                ...
                <p>Driving Business Flexibility, Growth mindset, Enabling Change across IT teams and integrating them
                    ...
                    business. Contact us today to schedule a consultation.</p>
            </div>
